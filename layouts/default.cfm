		...
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<div class="pull-right">
					<a href="https://github.com/adampresley/codedayspa"><img style="position: absolute; top: 0; right: 0; border: 0;" src="https://s3.amazonaws.com/github/ribbons/forkme_right_gray_6d6d6d.png" alt="Fork me on GitHub"></a>
				</div>
			</div> <!-- /.container-fluid -->
		</div> <!-- /.navbar-inner -->
	</div> <!-- /.navbar -->
